...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE
  accounts, account_fields, account_auth, account_codes, account_tags
TO authenticated;
REVOKE UPDATE, DELETE ON TABLE account_logs FROM authenticated;
GRANT SELECT, INSERT ON TABLE account_logs TO authenticated;
GRANT ALL ON TABLE
  accounts, account_fields, account_auth, account_codes, account_logs, account_tags
TO service_role;
REVOKE ALL ON TABLE
  accounts, account_fields, account_auth, account_codes, account_logs, account_tags
FROM anon;
GRANT SELECT ON tagged_items TO authenticated, service_role;
